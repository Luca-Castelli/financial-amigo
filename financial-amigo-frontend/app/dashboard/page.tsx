...
const holdingsData = [
  { id: 1, symbol: 'AAPL', name: 'Apple Inc.', quantity: 10, averageCost: 150, currentPrice: 175, currentValue: 1750, unrealizedPL: 250 },
  { id: 2, symbol: 'GOOGL', name: 'Alphabet Inc.', quantity: 5, averageCost: 2000, currentPrice: 2100, currentValue: 10500, unrealizedPL: 500 },
  { id: 3, symbol: 'MSFT', name: 'Microsoft Corporation', quantity: 15, averageCost: 200, currentPrice: 220, currentValue: 3300, unrealizedPL: 300 },
  { id: 4, symbol: 'AMZN', name: 'Amazon.com Inc.', quantity: 8, averageCost: 3000, currentPrice: 3200, currentValue: 25600, unrealizedPL: 1600 },
]
...
export default function Dashboard() {
  ...
  const totalPortfolioValue = holdingsData.reduce((sum, holding) => sum + holding.currentValue, 0)
  const totalUnrealizedPL = holdingsData.reduce((sum, holding) => sum + holding.unrealizedPL, 0)
  const percentageChange = (totalUnrealizedPL / (totalPortfolioValue - totalUnrealizedPL)) * 100
  const totalDividends = dividendsData.reduce((sum, dividend) => sum + dividend.amount, 0)
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="py-10">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <TabsContent value="overview" className="mt-6">
              <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="text-2xl font-bold">${totalUnrealizedPL.toLocaleString()}</div>
                    <p className="text-xs text-muted-foreground">
                      {percentageChange > 0 ? '+' : ''}{percentageChange.toFixed(2)}% overall
                    </p>
                  </CardContent>
                </Card>
                <Card>
            ...
            <TabsContent value="dividends" className="mt-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>A list of your received dividends.</CardDescription>
                </CardHeader>
                <CardContent>
                  <Table>
                    <TableHeader>
          ...
          <div className="mt-6">
            <NewsFeed symbols={holdingsData.length > 0 ? holdingsData.map(holding => holding.symbol) : ['AAPL', 'GOOGL', 'MSFT']} />
          </div>
        </div>
      </main>
    </div>
